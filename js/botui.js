...
botui.message.bot({
    ...
    return botui.message.bot({
        delay: 1000,
        content: "我是 v1sion ,你也可以叫我van 👀"
    })
}).then(function () {
    return botui.message.bot({
        delay: 1000,
        content: "练习写bug两年半,喜欢ctrl~"
    })
}).then(function () {
...
var other = function () {
    botui.message.bot({
        ...
        return botui.message.bot({
            delay: 1500,
            content: "技术什么的都会一丢丢,偶尔也搞搞PHP,研究下DIY主机"
        })
    }).then(function () {
        return botui.message.bot({
            delay: 1500,
            content: "主要的技术栈是 HTML/CSS/JavaScript/Vue/Uniapp/node 👈"
        })
    }).then(function () {
        return botui.message.bot({
            delay: 1500,
            content: "平时候喜欢逛逛论坛,进掘金摸摸🐟"
        })
    }).then(function () {
        return botui.message.bot({
            delay: 1500,
            content: "最喜欢FPS游戏,APEX..CSGO..VALORANT.. "
        })
    }).then(function () {
        return botui.action.button({
            delay: 1500,
        ...
        return botui.message.bot({
            delay: 1500,
            content: "因为发音和本名很相似啦~而且vision也有视野的意思,希望自己能够拓展视野 😃"
        })
    }).then(function () {
        return botui.action.button({
            delay: 1500,
        ...
        return botui.message.bot({
            delay: 1500,
            content: "最喜欢的电影是《楚门的世界》😎"
        })
    }).then(function (res) {
        return botui.message.bot({
            delay: 1500,
            content: "为此还将个性签名改成了里面最喜欢的台词 ———— How it is going to end"
        })
    }).then(function (res) {
            return botui.message.bot({
                delay: 1500,
                content: "希望我的文章对你有所帮助，那么是我的荣幸~ My pleasure~ 😊"
            })
        }).then(function (res) {
            return botui.message.bot({
                delay: 1500,
                content: "再次感谢光临寒舍,请仔细看看我的博客吧 @^_^"
            })
        });
}
